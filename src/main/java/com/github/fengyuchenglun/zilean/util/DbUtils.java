...
import static com.github.fengyuchenglun.zilean.constant.Constants.DOT;
...
public class DbUtils {
    ...
    private static final Pattern underLineToHumpPattern = Pattern.compile("_+([a-zA-Z])");
    private static final Pattern humpToUnderLinePattern = Pattern.compile("_+([a-zA-Z])");
    ...
    public static String humpToUnderLine(String s) {
        Matcher matcher = humpToUnderLinePattern.matcher(s);
