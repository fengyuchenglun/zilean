package com.github.fengyuchenglun.zilean.util;
...
import static com.github.fengyuchenglun.zilean.constant.Constants.UNIX_SEPARATOR;
    ...
    private static void copyResourceFile(String name, String toDir) {
        ...
        if (in != null) {
            try {
                ...
                FileUtils.writeStringToFile(new File(toDir + UNIX_SEPARATOR + name), data, StandardCharsets.UTF_8);
            } catch (IOException e) {
